<?php
	...
	*/
	...
	function doAffyStatistics($GET, $idStudy, $studyTitle){
		...
		$queryFiles = ("SELECT idFileType, folderName, fileName, idNorm FROM vFilesWithInfo WHERE idStudy = $idStudy AND idNorm = ".$GET['normSelect']." AND idFileType = 35;");
