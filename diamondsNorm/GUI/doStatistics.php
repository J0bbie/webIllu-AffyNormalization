...
<body onload="showStatistics()">
	<div id="normChoser">
		...
		<div id="form_container">
			...
			<form id="showNormInfo" class="appnitro" method="get" action="doStatistics">
	...
	<div id="statisticsOptions">
		...
		<div id="form_container">
			...
			<form action="getForm.php" method="GET" onsubmit="checkAttributes()" name="statisticsForm" id="statisticsForm">
				...
				<input id="formType" name="formType" class="element text large" type="hidden" value="statisticsForm" /> <input id="selectedAttributes" name="selectedAttributes" class="element text large"
					type="hidden" /> <input id="selectedSamples" name="selectedSamples" value=0 type="hidden" /> <input id="normSelect" name="normSelect" value=<?php echo $_GET['normSelect']; ?>
					class="element text large" type="hidden" />
				<div class="form_description">
