...
#userParameters <- getArguments(c("--statSubset", TRUE, "--statFile", "statSubsetFile.txt",  "--studyName", "AIMT2_LiverKidney", "-O", "/var/www/normdb/data/1_AIMT2_LiverKidney/statistics//2/", "-S", "2", "-j", "2", "-o", "/var/www/normdb/data/1_AIMT2_LiverKidney/expressionData/normed/2", "-i","/var/www/normdb/data/1_AIMT2_LiverKidney/expressionData/raw/","-s","Sample_Probe_Profile_102259-2.txt","-c", "Control_Probe_Profile_102259-2.txt","-d","descriptionFile.txt"))
...
if(userParameters$saveToDB){
          ...
          #idSampleVector stays constant for all the other files aswell so it saves them to do this.
