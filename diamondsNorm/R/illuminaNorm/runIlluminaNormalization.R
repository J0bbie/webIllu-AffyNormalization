...
# Testing parameter 
# userParameters <- getArguments(c( "--createLog", FALSE, 
#                                   "--idJob", "9", 
#                                   "--studyName", "AIMT2_LiverKidney", 
#                                   "--inputDir","/var/www/normdb//data/1_asd/expressionData/normed/4",
#                                   "--outputDir", "/var/www/normdb//data/1_asd/statistics//5/",
#                                   "--statisticsDir", "/var/www/normdb//data/1_asd/statistics/6/", 
#                                   "--sampleProbeProfilePath","Sample_Probe_Profile_102259-2.txt",
#                                   "--controlProbeProfilePath", "Control_Probe_Profile_102259-2.txt",
#                                   "--descFile","descriptionFile.txt", 
#                                   
#                                   "--normalize", FALSE,
#                                   "--normSubset", FALSE,
#                                   "--loadOldNorm", TRUE,
#                                   "--normData", "AIMT2_LiverKidney_normData.Rdata",
#                                   "--idNorm","4", 
#                                   "--createAnno", FALSE,
#                                   "--filtering", FALSE,
#                                   
#                                   "--idStatistics", "6", 
#                                   "--performStatistics", TRUE,
#                                   "--rawDataQC", FALSE,
#                                   "--normDataQC", TRUE,
#                                   "--statSubset", TRUE, 
#                                   "--perGroup", TRUE,
  ...
  if(userParameters$loadOldNorm == FALSE){
    ...
    if(userParameters$rawDataQC){
      ...
      if(userParameters$rawDataQC && userParameters$statSubset){
        ...
        rawData <- rawData[,na.omit(matchedSamplesOnArray)]
      ...
      if(userParameters$raw.pca) {  
        ...
        gar <- pcaFun(rawData, normalized=FALSE ,experimentFactor=experimentFactor, 
                      ...
                      namesInPlot=userParameters$img.nameInPCA,
                      WIDTH=userParameters$img.width,HEIGHT=userParameters$img.heigth,
